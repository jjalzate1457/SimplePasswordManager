...
namespace SimplePasswordManager
{
    public partial class Form1 : Form
    {
        ...
        private void lStatus_DoubleClick(object sender, EventArgs e)
        {
            logger.Show();
        }
        ...
        {
            if (MessageBox.Show("Are you sure you want to delete all data?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                Reset();
            }
        }
